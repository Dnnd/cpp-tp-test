...
public:
    ...
    void insert_fields(std::size_t index, const Fields &new_fields) {
        ...
        fields_.insert(fields_.begin() + index, new_fields.fields_.begin(), new_fields.fields_.end());
    }
    ...
    const field_t& operator[](std::size_t i) const {
        return fields_[i];
    }

    field_t& operator[](std::size_t i) {
        return fields_[i];
    }

    field_t get_field(std::size_t i) const {
        return fields_[i];
    }
private:
    fields_t fields_;
...
public:
    ...
    std::vector<Fields> read_fields_multiline(std::istream &in, size_t n_lines) const {
